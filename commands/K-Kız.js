...
module.exports.run = async (client, message, args) => {
  ...
  await member.roles.add(client.config.girlRoles).catch(err => { return undefined; });
  ...
  log.send(`${member} - (\`${member.id}\`) aramıza \`kız\` olarak katıldı! Kayıt Eden Yetkili: \`${message.author.tag}\``)
